...
public class CookDraniki implements ManufacturerStrategy {
    ...
    public CookDraniki(Manufacturer manufacturer) {
    ...
    /**
     * Cooking draniki from ingredients.
     *
    ...
    public FoodEntity cook() {
        ...
        if (isReadyForCooking()) {
            ...
            FoodEntity meal = new FoodEntity(DRANIKI, 1, 8);
            meal.addAction(meal + " with name " + DRANIKI.toString() + " was created by " + this);
            return meal;
        }
        LOGGER.warning("PRODUCT DRANIKI WAS NOT CREATED BY " + manufacturer.getName());
        return null;
    }
}
